...
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/kpimtextedit-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/kpimtextedit-22.08.1.tar.xz.sig
...
%prep
%setup -q -n kpimtextedit-22.08.1
cd %{_builddir}/kpimtextedit-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662763298
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5PimTextEdit.so.5.21.1
