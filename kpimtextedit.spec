...
Version  : 22.12.2
Release  : 49
URL      : https://download.kde.org/stable/release-service/22.12.2/src/kpimtextedit-22.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/kpimtextedit-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/kpimtextedit-22.12.2.tar.xz.sig
...
%prep
%setup -q -n kpimtextedit-22.12.2
cd %{_builddir}/kpimtextedit-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675645855
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kpimtextedit-%{version}/.codespellrc.license %{buildroot}/usr/share/package-licenses/kpimtextedit/c011fda7746c087a127999da1c4044854ee42238 || :
...
cp %{_builddir}/kpimtextedit-%{version}/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kpimtextedit/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9 || :
...
/usr/lib64/libKF5PimTextEdit.so.5.22.2
...
/usr/share/package-licenses/kpimtextedit/c011fda7746c087a127999da1c4044854ee42238
