...
Version  : 20.08.3
Release  : 25
URL      : https://download.kde.org/stable/release-service/20.08.3/src/kpimtextedit-20.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/kpimtextedit-20.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.3/src/kpimtextedit-20.08.3.tar.xz.sig
...
%prep
%setup -q -n kpimtextedit-20.08.3
cd %{_builddir}/kpimtextedit-20.08.3
...
cp %{_builddir}/kpimtextedit-20.08.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/kpimtextedit/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5PimTextEdit.so.5.15.3
