...
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/kpimtextedit-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/kpimtextedit-19.12.2.tar.xz.sig
...
%prep
%setup -q -n kpimtextedit-19.12.2
cd %{_builddir}/kpimtextedit-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581029557
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kpimtextedit-19.12.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/kpimtextedit/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
