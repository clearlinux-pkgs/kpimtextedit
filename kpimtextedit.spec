...
Source0  : https://download.kde.org/stable/applications/19.04.3/src/kpimtextedit-19.04.3.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.3/src/kpimtextedit-19.04.3.tar.xz.sig
...
%prep
%setup -q -n kpimtextedit-19.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562878939
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5PimTextEdit.so.5.11.3
