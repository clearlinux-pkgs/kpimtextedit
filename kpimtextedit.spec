...
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kpimtextedit-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kpimtextedit-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kpimtextedit-22.12.3
cd %{_builddir}/kpimtextedit-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677783584
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5PimTextEdit.so.5.22.3
